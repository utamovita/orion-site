...
function Blog() {
    ...
    return (
        <div className={styles.wrapper}>
            ...
            {isGalleryOpen && <SliderFullscreen onClose={() => setIsGalleryOpen(false)} images={sliderData} startingSlide={startingSlide}/>}
        </div>
    );
}
    ...
    return (
        <div className={styles.sectionWrapper}>
            <Container className={styles.gridWrapper}>
                <div className={styles.gridItem}>{item.title[locale as Locale]}{" "}
                  <span className={styles.subtitle}>{item.subtitle}</span></div>
