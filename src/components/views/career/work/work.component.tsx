...
function Work() {
    ...
    return (
        <>
            <>
                {isJobCarrierOpen && <WorkPopup Form={<CarrierForm/>} img={carrierImage} title={t("career.form.carrier.title")}
                                                onClose={() => setJobCarrierOpen(false)}/>}
                {isJobDriverOpen && <WorkPopup Form={<WorkForm/>} img={driverImage} title={t("career.form.driver.title")}
                                               onClose={() => setJobDriverOpen(false)}/>}
                {isJobDispatcherOpen && <WorkPopup Form={<WorkForm/>} img={dispatcherImage} title={t("career.form.dispatcher.title")}
                                                   onClose={() => setJobDispatcherOpen(false)}/>}
                {isJobForwarderOpen && <WorkPopup Form={<WorkForm/>} img={forwarderImage} title={t("career.form.forwarder.title")}
                                                  onClose={() => setJobForwarderOpen(false)}/>}
                {isJobAdministrationOpen && <WorkPopup Form={<WorkForm/>} img={administrationImage} title={t("career.form.administration.title")}
