                ...
                <div className={styles.wrapper}>
                    ...
                    <div className={styles.contentWrapper}>
                        ...
                        <div className={styles.infoWrapper}>
                            <Image src={img} alt={"grand transport logistic work"} placeholder="blur"
                                   quality={90}
                                   width={810}
                                      height={540}
                                   style={{
                            ...
                            <div className={styles.noteWrapper}>
                                ...
                                <a href={"mailto:office@grandtransportlogistics.eu"}
                                   className={styles.noteEmail}>office@grandtransportlogistics.eu</a>
                            </div>
                        </div>
                    </div>
                </div>
