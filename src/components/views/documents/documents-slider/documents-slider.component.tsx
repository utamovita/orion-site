                ...
                {documentsConfig.map(({image, title, subtitle, link}) => (
                    <SwiperSlide key={image.alt} className={styles.swiperSlide}>
                        <div className={styles.slideContent}>
                            <Image src={image.url} alt={image.alt} className={styles.image} width={image.width} height={image.height} />
                            <div className={styles.overlay}>
                                <div className={styles.textWrapper}>
                                    <Stack space={"M"} className={styles.stack}>
                                        ...
                                        <ButtonLink newTab={true} to={link} variant={"secondary"}
                                                    className={styles.documentBtn}>{t("sprawdź")}</ButtonLink>
                                    </Stack>
                                </div>
                            </div>
                        </div>
